    ...
    <div className="w-[90%] mx-auto ">
      ...
      <div className="flex  justify-between mt-12">
        <div>
          ...
          <button
            type="button"
            class="text-gray-900 w-48 bg-gradient-to-r mt-1 from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
          >
            Start today
          </button>
        </div>
